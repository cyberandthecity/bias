export const InterfaceColor = "#44517E"
export const BackgroundColor = "#F6F8FF"
...
export const AIDarkGradient =
	" linear-gradient(180deg, rgba(244, 241, 244, 0) 0%, #5C237C 100%), linear-gradient(97.73deg, #000000 0%, #1C064D 0.01%)"
